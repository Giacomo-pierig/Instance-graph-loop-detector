...
class EventLog:
    ...
    def detect(self, pattern_type, delta=0, abstract=False):
        ...
        # Se il flag abstract è impostato a True, ciascuno dei pattern trovati viene rimpiazzato con un'astrazione
